...
const { updateUserDetails, getAllUsers, registerUserGoogleAuth, adminUpdateUserDetails } = require('../controllers/userController')
...
router.post('/create', registerUser)
router.put('/edit/:id', adminUpdateUserDetails)
